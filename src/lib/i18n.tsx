...
export const DICT: Dict = {
  ...
  'sub.subtitle': {
    id: 'WargaJagaWarga adalah aplikasi berbayar PER-KLASTER yang diawasi oleh Superadmin. Setiap klaster baru mendapat masa percobaan gratis 14 hari. Status billing memengaruhi pengiriman Emergency Alert.',
    en: 'WargaJagaWarga is a PER-CLUSTER paid app supervised by the Superadmin. Every new cluster gets a 14-day free trial. Billing status affects Emergency Alert sending.',
  },
  ...
  'sub.expired': {
    id: 'Langganan klaster telah berakhir. Emergency Alert DIBLOKIR sampai Admin melunasi tagihan.',
    en: 'The cluster subscription has ended. Emergency Alert is BLOCKED until the Admin settles the bill.',
  },
  ...
  'sub.billingBlocked': {
    id: 'Emergency Alert DIBLOKIR — masalah pembayaran klaster',
    en: 'Emergency Alert BLOCKED — cluster payment issue',
  },
