...
export const Navbar: React.FC<NavbarProps> = ({
  ...
  const navItems = [
    ...
    { id: 'app', label: 'Aplikasi Darurat', icon: ShieldAlert, alert: activeIncidentsCount > 0 },
    { id: 'map', label: 'Peta Klaster', icon: MapPin },
    { id: 'directory', label: 'Warga & Satpam', icon: Users },
    { id: 'stats', label: 'Data Keamanan', icon: BarChart3 },
    { id: 'contact', label: 'Hubungi / Daftar', icon: Mail },
  ];
        ...
        <div className="flex items-center justify-between h-16">
          ...
          <div className="flex items-center space-x-2 sm:space-x-3">
            ...
            <button
              ...
              title={soundEnabled ? 'Suara Sirine Aktif' : 'Suara Sirine Bisukan'}
                  ...
                  <div className="absolute right-0 mt-2 w-72 bg-slate-900 border border-slate-700 rounded-xl shadow-2xl z-50 py-2 divide-y divide-slate-800">
                    <div className="px-4 py-2">
                      ...
                      <p className="text-[11px] text-slate-500 mt-0.5">
                        Pilih untuk merasakan aplikasi sebagai Warga, Satpam, RT, atau Superadmin
                      </p>
                    </div>
