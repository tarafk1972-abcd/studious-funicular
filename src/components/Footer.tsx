    ...
    <footer className="bg-slate-950 text-slate-400 border-t border-slate-800">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-14">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div className="md:col-span-2 space-y-4">
            ...
            <p className="text-sm text-slate-400 max-w-sm leading-relaxed">
              Tanggap Darurat untuk Komunitas yang Lebih Aman. Satu sentuhan, Satpam dan tetanggamu datang.
            </p>
          ...
          <div className="space-y-3">
            <h4 className="text-sm font-bold text-white uppercase tracking-wider">Navigasi Platform</h4>
          ...
          {/* Contact */}
          <div className="space-y-3">
            <h4 className="text-sm font-bold text-white uppercase tracking-wider">Hubungi Tim Kami</h4>
            <ul className="space-y-2 text-xs">
              <li className="flex items-center space-x-2">
                <Mail className="w-4 h-4 text-red-500 shrink-0" />
                <a href="mailto:email@mybusiness.com" className="hover:text-white">
        ...
        <div className="mt-12 pt-8 border-t border-slate-900 flex flex-col sm:flex-row items-center justify-between gap-4 text-xs">
          <p>
            &copy; {new Date().getFullYear()} WargaJagaWarga. Tanggap Darurat untuk Komunitas yang Lebih Aman.
          </p>
