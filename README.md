...
### 8. 💳 Aplikasi Berbayar & Masa Percobaan Gratis 14 Hari
- WargaJagaWarga adalah **aplikasi berbayar yang diawasi oleh Superadmin** (tarafk1972@gmail.com).
- Setiap anggota baru mendapatkan **masa percobaan GRATIS selama 14 hari** sejak pendaftaran.
- Setelah masa percobaan berakhir, anggota memilih paket **Bulanan (Rp 25.000/bulan)** atau **Tahunan (Rp 250.000/tahun — hemat 2 bulan)** melalui tab **Langganan** (pembayaran simulasi).
- **Panel Pengawasan Langganan Superadmin:** Superadmin dapat memantau status langganan seluruh anggota, **memperpanjang trial +14 hari**, **menangguhkan**, atau **mengaktifkan** akun anggota.
...
- **REST API Endpoints:**
  ...
  - `GET /api/users` & `POST /api/users` — Direktori Warga dan Satpam (pendaftaran dengan pilihan bahasa & trial 14 hari otomatis).
  ...
  - `POST /api/subscriptions` — Pembayaran langganan (simulasi) dan aksi pengawasan langganan oleh Superadmin (perpanjang trial, tangguhkan, aktifkan).
